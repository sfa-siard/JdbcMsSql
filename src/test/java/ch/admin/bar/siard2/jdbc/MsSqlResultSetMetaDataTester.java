...
public class MsSqlResultSetMetaDataTester
    ...
    private static String _sNativeQuerySimple = getTableQuery(TestMsSqlDatabase.getQualifiedSimpleTable(),
                                                              TestMsSqlDatabase._listCdSimple);
    private static String _sNativeQueryComplex = getTableQuery(TestMsSqlDatabase.getQualifiedComplexTable(),
                                                               TestMsSqlDatabase._listCdComplex);
    private static String _sSqlQuerySimple = getTableQuery(TestSqlDatabase.getQualifiedSimpleTable(),
                                                           TestSqlDatabase._listCdSimple);
    private static String _sSqlQueryComplex = getTableQuery(TestSqlDatabase.getQualifiedComplexTable(),
                                                            TestSqlDatabase._listCdComplex);
    ...
    public void setUp() {
        try {
            Connection conn = connectionConfig.connect();
    ...
    public void testClass() {
        assertEquals("Wrong result set metadata class!",
                     MsSqlResultSetMetaData.class,
                     getResultSetMetaData().getClass());
    } /* testClass */
