...
public class MsSqlDatabaseMetaDataTester extends BaseDatabaseMetaDataTester {
    ...
    private static QualifiedId _qiGeometryType = new QualifiedId(connectionConfig.name(), "sys", "geometry");
    private static QualifiedId _qiGeographyType = new QualifiedId(connectionConfig.name(), "sys", "geography");
    private static QualifiedId _qiHierarchyIdType = new QualifiedId(connectionConfig.name(), "sys", "hierarchyid");
            ...
            if ((rs != null) && (!rs.isClosed())) {
                ...
                while (rs.next()) {
                    ...
                    if (sCatalogName != null) {
                        if (!connectionConfig.name().equalsIgnoreCase(sCatalogName))
    ...
    private void testGetUDTs(QualifiedId qiType) {
      ...
      */
            while (rs.next()) {
                ...
                System.out.println(qiType.format() + "\t" + sClassName + "\t" + String.valueOf(iDataType) + " (" + SqlTypes.getTypeName(
                        iDataType) + ")\t" + String.valueOf(iBaseType) + " (" + SqlTypes.getTypeName(iBaseType) + ")");
            }
            rs.close();
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
    ...
    public void testSupportsResultSetType() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            ...
            try {
                println(sSqlType + ": " + String.valueOf(_dmdMsSql.supportsResultSetType(iType)));
            } catch (SQLException se) {
    ...
    public void testSupportsResultSetConcurrency() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            ...
            String sSqlType = SqlTypes.getTypeName(iType);
            try {
                println(sSqlType + " (READ_ONLY): " + String.valueOf(_dmdMsSql.supportsResultSetConcurrency(iType,
                                                                                                            ResultSet.CONCUR_READ_ONLY)));
            } catch (SQLException se) {
                System.out.println(EU.getExceptionMessage(se));
            }
            try {
                println(sSqlType + " (UPDATABLE): " + String.valueOf(_dmdMsSql.supportsResultSetConcurrency(iType,
    ...
    public void testOwnUpdatesAreVisible() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            int iType = listTypes.get(i).intValue();
            try {
                println(SqlTypes.getTypeName(iType) + ": " + String.valueOf(_dmdMsSql.ownUpdatesAreVisible(iType)));
            } catch (SQLException se) {
                System.out.println(EU.getExceptionMessage(se));
            }
        }
    ...
    public void testOwnDeletesAreVisible() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            int iType = listTypes.get(i).intValue();
            try {
                println(SqlTypes.getTypeName(iType) + ": " + String.valueOf(_dmdMsSql.ownDeletesAreVisible(iType)));
            } catch (SQLException se) {
                System.out.println(EU.getExceptionMessage(se));
            }
        }
    ...
    public void testOwnInsertsAreVisible() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            int iType = listTypes.get(i).intValue();
            try {
                println(SqlTypes.getTypeName(iType) + ": " + String.valueOf(_dmdMsSql.ownInsertsAreVisible(iType)));
            } catch (SQLException se) {
                System.out.println(EU.getExceptionMessage(se));
            }
        }
    ...
    public void testOthersUpdatesAreVisible() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            int iType = listTypes.get(i).intValue();
            try {
                println(SqlTypes.getTypeName(iType) + ": " + String.valueOf(_dmdMsSql.othersUpdatesAreVisible(iType)));
            } catch (SQLException se) {
                System.out.println(EU.getExceptionMessage(se));
            }
        }
    ...
    public void testOthersDeletesAreVisible() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            int iType = listTypes.get(i).intValue();
            try {
                println(SqlTypes.getTypeName(iType) + ": " + String.valueOf(_dmdMsSql.othersDeletesAreVisible(iType)));
            } catch (SQLException se) {
                System.out.println(EU.getExceptionMessage(se));
            }
        }
    ...
    public void testOthersInsertsAreVisible() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            int iType = listTypes.get(i).intValue();
            try {
                println(SqlTypes.getTypeName(iType) + ": " + String.valueOf(_dmdMsSql.othersInsertsAreVisible(iType)));
            } catch (SQLException se) {
                System.out.println(EU.getExceptionMessage(se));
            }
        }
    ...
    public void testUpdatesAreDetected() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            int iType = listTypes.get(i).intValue();
            try {
                println(SqlTypes.getTypeName(iType) + ": " + String.valueOf(_dmdMsSql.updatesAreDetected(iType)));
            } catch (SQLException se) {
                System.out.println(EU.getExceptionMessage(se));
            }
        }
    ...
    public void testDeletesAreDetected() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            int iType = listTypes.get(i).intValue();
            try {
                println(SqlTypes.getTypeName(iType) + ": " + String.valueOf(_dmdMsSql.deletesAreDetected(iType)));
            } catch (SQLException se) {
                System.out.println(EU.getExceptionMessage(se));
            }
        }
    ...
    public void testInsertsAreDetected() {
        ...
        for (int i = 0; i < listTypes.size(); i++) {
            int iType = listTypes.get(i).intValue();
            try {
                println(SqlTypes.getTypeName(iType) + ": " + String.valueOf(_dmdMsSql.insertsAreDetected(iType)));
            } catch (SQLException se) {
                System.out.println(EU.getExceptionMessage(se));
            }
        }
    ...
    public void testGetTables() {
        enter();
        try {
            print(_dmdMsSql.getTables(null, TestSqlDatabase._sTEST_SCHEMA, "%", new String[]{"TABLE"}));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetViews() {
        enter();
        try {
            print(_dmdMsSql.getTables(null, TestSqlDatabase._sTEST_SCHEMA, "%", new String[]{"VIEW"}));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    public void testGetCrossReference() {
        enter();
        try {
            print(_dmdMsSql.getCrossReference(null,
                                              TestSqlDatabase._sTEST_SCHEMA,
                                              "%",
                                              null,
                                              TestSqlDatabase._sTEST_SCHEMA,
                                              "%"));
